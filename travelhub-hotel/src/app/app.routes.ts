  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('./features/reservation-detail/reservation-detail.component').then(m => m.ReservationDetailComponent),
      },
      {
        path: 'rooms',
      ...
      {
        path: 'tariffs',
        loadComponent: () => import('./features/tariffs/tariffs.component').then(m => m.TariffsComponent),
      },
    ]
  },
